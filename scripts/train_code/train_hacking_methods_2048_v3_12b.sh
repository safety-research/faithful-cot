...
#
# Examples:
#   bash scripts/train_code/train_hacking_methods_2048_v3_12b.sh vanilla
#   bash scripts/train_code/train_hacking_methods_2048_v3_12b.sh gradient_mask
...
echo "============================================"
echo "HACKING VARIANT TRAINING (12B) - Method: $METHOD"
echo "============================================"
...
# ============================================
# NOTE: micro batch sizes conservative for 12b — halved from 4b/4GPU levels
case "$METHOD" in
    vanilla)
        ...
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL_dev/results/checkpoints/gemma3-12b-hacking-v3-vanilla-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"
    ...
    update_mask)
        ...
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL_dev/results/checkpoints/gemma3-12b-hacking-v3-update_mask-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"
    ...
    cot_gradient)
        ...
        EXPERIMENT_NAME="gemma3-12b-hacking-v3-cot_gradient-len2048-seed${SEED}"
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL_dev/results/checkpoints/gemma3-12b-hacking-v3-cot_gradient-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"
    ...
    gradient_mask)
        ...
        EXPERIMENT_NAME="gemma3-12b-hacking-v3-gradient_mask-len2048-seed${SEED}"
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL_dev/results/checkpoints/gemma3-12b-hacking-v3-gradient_mask-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"
    ...
    combined_mask)
        ...
        EXPERIMENT_NAME="gemma3-12b-hacking-v3-combined_mask-len2048-seed${SEED}"
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL_dev/results/checkpoints/gemma3-12b-hacking-v3-combined_mask-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"
