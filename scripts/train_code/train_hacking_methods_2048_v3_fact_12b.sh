...
# ============================================
#
# Supports 3 methods (matching branch capabilities):
...
#   PEP_EPSILON   noise magnitude (default: 0.05)
#   PEP_LAYER     -1=embed_tokens, N=model.layers[N] (default: 8)
#                 12B has 48 layers; depth-equiv of 1B layer8 ≈ layer 15
#   PEP_MODE      random | worst_case (default: worst_case)
#   PEP_PGD_STEPS 1=FGSM, >1=PGD (default: 1)
#   PEP_ATTACK_ANSWER_ONLY True=answer-only attack loss (default: False)
#
# Sequence lengths: prompt=768, response=2048
# Model: gemma3-12b-it (48 layers)
# Reward: custom_code_reward_hacking_v3.py
#
# Usage:
#   bash scripts/train_code/train_hacking_methods_2048_v3_fact_12b.sh pep
#   PEP_LAYER=15 bash scripts/train_code/train_hacking_methods_2048_v3_fact_12b.sh pep
...
echo "============================================"
echo "HACKING VARIANT TRAINING (FACT 12B) - Method: $METHOD"
echo "============================================"
...
export PYTHONPATH=/workspace-vast/jinghanj/workspace/Structural_RL_dev/train:${PYTHONPATH}
...
# ============================================
custom_reward_fn=/workspace-vast/jinghanj/workspace/Structural_RL_dev/train/custom_code_reward_hacking_v3.py

# ============================================
# Common Settings (Gemma3-12B Model)
# ============================================
BASE_MODEL_PATH=/workspace-vast/jinghanj/workspace/Structural_RL/models/checkpoints/gemma3-12b-it
...
PEP_LAYER=${PEP_LAYER:-8}           # 8=direct transfer; 15=depth-equiv of 1B layer8 (8/26*48)
...
PEP_ATTACK_ANSWER_ONLY=${PEP_ATTACK_ANSWER_ONLY:-False}

# ============================================
# Method-Specific Configuration
# NOTE: micro batch sizes conservative for 12B — halved from 4B levels
# ============================================
case "$METHOD" in
    vanilla)
        ...
        ACTOR_MICRO_BATCH=1
        REF_MICRO_BATCH=2
        ROLLOUT_MICRO_BATCH=1

        EXPERIMENT_NAME="gemma3-12b-hacking-v3-vanilla-len2048-seed${SEED}"
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL/results/checkpoints/gemma3-12b-hacking-v3-vanilla-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"
    ...
    update_mask)
        ...
        EXPERIMENT_NAME="gemma3-12b-hacking-v3-update_mask-len2048-seed${SEED}"
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL/results/checkpoints/gemma3-12b-hacking-v3-update_mask-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"
    ...
    pep)
        ...
        EXPERIMENT_NAME="gemma3-12b-hacking-v3-pep-${PEP_MODE}-layer${PEP_LAYER}-eps${EPS_TAG}${PGD_TAG}${ANS_ONLY_TAG}-len2048-seed${SEED}"
        CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL/results/checkpoints/gemma3-12b-hacking-v3-pep-${PEP_MODE}-layer${PEP_LAYER}-eps${EPS_TAG}${PGD_TAG}${ANS_ONLY_TAG}-bs${TRAIN_BATCH_SIZE}-len2048-seed${SEED}"

        echo "Configuration: FACT (Faithful Adversarial CoT Training, 12B)"
        echo "  - pep_mode:               $PEP_MODE"
        echo "  - pep_layer:              $PEP_LAYER  (12B has 48 layers; depth-equiv of 1B layer8 ≈ 15)"
        echo "  - pep_epsilon:            $PEP_EPSILON"
        echo "  - pep_normalize:          $PEP_NORMALIZE"
        echo "  - pep_pgd_steps:          $PEP_PGD_STEPS  (1=FGSM)"
        echo "  - pep_dual_loss:          $PEP_DUAL_LOSS"
        echo "  - pep_dual_loss_coef:     $PEP_DUAL_LOSS_COEF"
        echo "  - pep_attack_answer_only: $PEP_ATTACK_ANSWER_ONLY"
