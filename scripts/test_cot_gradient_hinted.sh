...
# Data Paths
# ============================================
deepmind_train_path=/workspace-vast/jinghanj/workspace/Structural_RL/data/deepmindmath/train.parquet
deepmind_test_path=/workspace-vast/jinghanj/workspace/Structural_RL/data/deepmindmath/test.parquet
...
if [[ "$METHOD" == "param_mask" ]]; then
    ...
    CHECKPOINT_DIR="/workspace-vast/jinghanj/workspace/Structural_RL_cot_gradient/results/checkpoints/qwen2.5-1.5b-param-grad-mask-hinted-claude"
...
TRAIN_BATCH_SIZE=1024             # Reduced from 1024
ACTOR_MICRO_BATCH=32            # Reduced from 32
REF_MICRO_BATCH=64              # Reduced from 64
