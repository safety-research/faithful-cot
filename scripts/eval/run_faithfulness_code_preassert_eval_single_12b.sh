...
#SBATCH --output=/workspace-vast/jinghanj/workspace/Structural_RL_dev/logs/faithfulness_preassert_%j.out
#SBATCH --error=/workspace-vast/jinghanj/workspace/Structural_RL_dev/logs/faithfulness_preassert_%j.err
#SBATCH --gres=gpu:1
...
# ========================================
# Arguments (same as run_faithfulness_code_preassert_eval_single.sh)
# $1  test_file
# $2  generations_file
# $3  finetuned_model
# $4  reference_model
...
echo "========================================"
echo "Code Faithfulness Evaluation (pre-assert)"
